window.RuntimeI18n = (function () {
  ...
  tr: {
    ...
    routePanelStopsTitle: 'Duraklar',
    routePanelVariantsTitle: 'Varyantlar',
    routePanelTripsSuffix: 'sefer',
    routePanelNoStopsFound: 'Bu seçim için durak bulunamadı.',
    routePanelSelectVariant: 'Bu varyanta odaklan',
    routePanelDeselectVariant: 'Seçimi kaldır',
  ...
  en: {
    ...
    routePanelStopsTitle: 'Stops',
    routePanelVariantsTitle: 'Variants',
    routePanelTripsSuffix: 'trips',
    routePanelNoStopsFound: 'No stops found for this selection.',
    routePanelSelectVariant: 'Focus this variant',
    routePanelDeselectVariant: 'Deselect',
